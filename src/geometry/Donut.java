...
public class Donut extends Circle{
	...
	public String toString () {
		return "Center point =" + super.getCenter() + " Radius =" + super.getRadius()  + " Inner radius =" + innerRadius;
	...
	public boolean equals ( Object obj) {
		 if (obj instanceof Donut)
		 {
			 ...
			 if (pomocna.getCenter().equals(getCenter()) && pomocna.getRadius() == getRadius() && pomocna.innerRadius == innerRadius)
				 return true;
			 return false;
		 }
		 return false;
	...
	public void fill (Graphics g)
	{
		...
		g.fillOval(getCenter().getX() - innerRadius,getCenter().getY() - innerRadius, innerRadius*2-2, innerRadius*2-2);
	}
