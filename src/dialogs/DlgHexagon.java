...
public class DlgHexagon extends JDialog {
	...
	private void createContent() {
		...
		addInputRow(contentPanel, "X coordinate", createTextField(), 0);

		txtX = lastCreatedTextField;

		addInputRow(contentPanel, "Y coordinate", createTextField(), 1);

		txtY = lastCreatedTextField;

		addInputRow(contentPanel, "Radius", createTextField(), 2);

		txtRadius = lastCreatedTextField;

		btnEdgeColor = createColorButton("Edge color", edgeColor);

		addColorRow(contentPanel, "Edge color", btnEdgeColor, 3);

		btnInnerColor = createColorButton("Fill color", innerColor);

		addColorRow(contentPanel, "Fill color", btnInnerColor, 4);
		...
		btnEdgeColor.addActionListener(
			...
			public void actionPerformed(ActionEvent e) {
				...
				Color selectedColor = JColorChooser.showDialog(DlgHexagon.this, "Choose edge color", edgeColor);
		...
		btnInnerColor.addActionListener(
			...
			public void actionPerformed(ActionEvent e) {
				...
				Color selectedColor = JColorChooser.showDialog(DlgHexagon.this, "Choose fill color", innerColor);

				if (selectedColor != null) {

					innerColor = selectedColor;

					updateColorButton(btnInnerColor, innerColor);
				}
			}
		});
	...
	private void saveHexagon() {
		...
		try {
			...
			hexagon = new HexagonAdapter(new Point(x, y), radius, false, edgeColor, innerColor);
