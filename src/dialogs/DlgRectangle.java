...
public class DlgRectangle extends JDialog {
	...
	private void createHeader() {
		...
		JLabel lblSubtitle = new JLabel("Enter position, dimensions and colors");
	...
	private void createContent() {
		...
		addInputRow(contentPanel, "Width", txtWidth, 2);

		txtHeight = createTextField();
		addInputRow(contentPanel, "Height",	txtHeight, 3);
		...
		btnEdgeColor.addActionListener(
			...
			public void actionPerformed(ActionEvent e) {
				...
				Color selectedColor = JColorChooser.showDialog(DlgRectangle.this, "Choose edge color", edgeColor);
		...
		btnFillColor.addActionListener(
			...
			public void actionPerformed(ActionEvent e) {
				...
				Color selectedColor = JColorChooser.showDialog(DlgRectangle.this, "Choose fill color", innerColor);
